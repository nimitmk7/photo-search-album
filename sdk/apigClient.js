...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: '',
            apiKey: "hL7lGptpg95IT06L23edP3O6z9MVHBf43a29vc9m",
    ...
    var invokeUrl = 'https://ekmjwgj7a9.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customlabels', 'Content-Type'], ['body']);
